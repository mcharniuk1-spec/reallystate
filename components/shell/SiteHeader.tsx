...
const NAV_ITEMS = [
  { href: "/", label: "Main", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" },
  ...
  { href: "/settings", label: "Profile", icon: "M12 12a5 5 0 100-10 5 5 0 000 10zM20 21a8 8 0 10-16 0" },
  { href: "/admin", label: "Insights", icon: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z" },
] as const;
      ...
      <div className="flex items-center justify-between gap-4 px-4 py-2.5 sm:px-6 max-w-[1920px] mx-auto">
        ...
        <div className="flex items-center gap-5">
          <Link href="/" className="font-display text-lg tracking-tight text-ink shrink-0">
            Liquid<span className="text-sea"> Intelligence</span>
          </Link>
        ...
        <div className="flex items-center gap-3">
          <Link href="/chat" className="hidden sm:grid h-8 w-8 place-items-center rounded-full text-mist hover:bg-paper hover:text-ink" title="Chats">●</Link>
